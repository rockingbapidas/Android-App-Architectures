...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.bapidas.news.di.module.provide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.bapidas.news.di.module.provide.GlideOptions().apply(toSet));
    }
  }
}
